...
function FormRequest() {
    ...
    const [filteredForms, setFilteredForms] = useState([]);import React, { useState, useEffect } from "react";
import Table from "../components/Table";
import axios from 'axios';
    ...
    useEffect(() => {
        ...
        if (sortColumn) {
            currentFilteredForms.sort((a, b) => {
                ...
                if (sortColumn === 'date' || sortColumn === 'updatedDate') {
        ...
        if (isAddingNewForm) {
            try {
                ...
                const formattedNewForm = {
                    ...
                    updatedDate: new Date(newFormFromApi.updated_at || newFormFromApi.created_at).toLocaleDateString("vi-VN"),
            ...
            try {
                ...
                const updatedForms = stagedForms.map(form =>
                    form.id === formBeingEdited.id ? {
                        ...
                        updatedDate: new Date(updatedFormFromApi.updated_at).toLocaleDateString("vi-VN")
                    } : form
                );
                setStagedForms(updatedForms);
                setOriginalForms(updatedForms);
