...
    }, []);
    ...
    const StatCard = ({ icon, title, value, color }) => {
        const colorClasses = {
            blue: { bg: 'bg-blue-100', text: 'text-blue-600', iconBg: 'text-blue-50' },
            yellow: { bg: 'bg-yellow-100', text: 'text-yellow-600', iconBg: 'text-yellow-50' },
            green: { bg: 'bg-green-100', text: 'text-green-600', iconBg: 'text-green-50' },
            purple: { bg: 'bg-purple-100', text: 'text-purple-600', iconBg: 'text-purple-50' },
        };
        const selectedColor = colorClasses[color] || colorClasses.blue;
        const IconComponent = icon;

        return (
            <div className={`relative bg-white p-6 rounded-2xl shadow-sm overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1`}>
                <IconComponent className={`absolute -right-4 -bottom-4 h-24 w-24 ${selectedColor.iconBg} opacity-80`} strokeWidth={1} />
...
                <h1 className="text-4xl font-extrabold text-gray-900">Tổng quan Dashboard</h1>
