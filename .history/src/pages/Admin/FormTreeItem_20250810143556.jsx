...
import {
    ...
    PlusIcon, PencilIcon, TrashIcon, Cog6ToothIcon, DocumentDuplicateIcon
} from '@heroicons/react/24/outline';

const FormTreeItem = ({ item, onEdit, onDelete, onAddChild, onEditFields, onLayout, depth = 0 }) => {
                    ...
                    {item.type === 'form' && (
                        <>
                            <button
                                ...
                                className="p-1 text-gray-500 hover:text-indigo-600 transition-transform duration-200 hover:scale-125"
                            ...
                            <button
                                ...
                                title="Chỉnh sửa các trường (Modal)"
                            >
