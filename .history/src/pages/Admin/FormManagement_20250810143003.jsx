...
const FormLayoutManager = () => {
    ...
    const handleDeleteItem = (id, name, type) => {
        Swal.fire({
            ...
            confirmButtonText: 'Vâng, xoá nó!', cancelButtonText: 'Hủy'
        }).then(async (result) => {
            if (result.isConfirmed) {
                ...
                } catch (err) { Swal.fire('Lỗi!', `Xóa thất bại: ${err.message}`, 'error'); }
            }
        });
    };

    const handleOpenFieldEditor = (formItem) => {
        setSelectedFormForFields({ id: formItem.id.replace('form-', ''), name: formItem.name });
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 p-4">
                        <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md">
                            ...
                            <form onSubmit={handleSubmitItemForm}>
                                {/* ... JSX cho modal tạo/sửa thư mục và tên biểu mẫu ... */}
                                <div className="mb-5">
