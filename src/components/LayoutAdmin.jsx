                    ...
                    <ul class="space-y-2 font-medium">
                        ...
                        <li>
                            <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                                ...
                                <Link to="/admin/create-field" class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Quản lí Field</Link>
                            </button>
                        </li>
                        <li>
                            <Link to="/admin/form-management" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span class="flex-1 whitespace-nowrap">Quản lí giao diện Form</span>
                            </Link>
                        </li>
                        <li>
